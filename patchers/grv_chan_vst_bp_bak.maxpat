...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 495.0, 28.0, 59.0, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 611.0, 538.0, 61.0, 22.0 ],
					"text" : "makenote"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 445.0, 62.0, 336.0, 53.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 71.0, 513.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 194.0, 165.0, 75.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 182.0, 66.0, 63.0, 24.0 ],
					"text" : "disable",
					"texton" : "disable"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 117.0, 66.0, 63.0, 24.0 ],
					"text" : "bypass",
					"texton" : "bypass"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 66.5, 41.0, 23.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 218.0, 17.0, 37.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-38",
					"items" : [ "Alternator", ",", "Array", ",", "AUAudioFilePlayer", ",", "AUBandpass", ",", "AUDelay", ",", "AUDistortion", ",", "AUDynamicsProcessor", ",", "AUFilter", ",", "AUGraphicEQ", ",", "AUHighShelfFilter", ",", "AUHipass", ",", "AULowpass", ",", "AULowShelfFilter", ",", "AUMatrixMixer", ",", "AUMatrixReverb", ",", "AUMIDISynth", ",", "AUMixer", ",", "AUMixer3D", ",", "AUMultibandCompressor", ",", "AUMultiChannelMixer", ",", "AUMultiSplitter", ",", "AUNBandEQ", ",", "AUNetReceive", ",", "AUNetSend", ",", "AUNewPitch", ",", "AUParametricEQ", ",", "AUPeakLimiter", ",", "AUPitch", ",", "AUReverb2", ",", "AURogerBeep", ",", "AURoundTripAAC", ",", "AUSampleDelay", ",", "AUSampler", ",", "AUScheduledSoundPlayer", ",", "AUSoundFieldPanner", ",", "AUSpatialMixer", ",", "AUSpeechSynthesis", ",", "AUSphericalHeadPanner", ",", "AUVectorPanner", ",", "Bidule FX (sidechain)", ",", "Bidule FX", ",", "Bidule MFX", ",", "Bidule MIDI", ",", "Bidule", ",", "Big Goat", ",", "Bitfight83", ",", "Blend", ",", "Blue Face", ",", "Captain Chords_MidiEffects", ",", "Captain Chords_Synth", ",", "Captain Deep_MidiEffects", ",", "Captain Deep_Synth", ",", "Captain Melody_MidiEffects", ",", "Captain Melody_Synth", ",", "Captain Play_MidiEffects", ",", "Captain Play_Synth", ",", "Cluster", ",", "Corrosion", ",", "Curve2", ",", "Deleight", ",", "Dipole", ",", "Discord4", ",", "Dispersion", ",", "Distortion 1", ",", "DLSMusicDevice", ",", "Drone Piano", ",", "Droplet", ",", "Dubstation 2", ",", "Echoes T7E", ",", "Emission", ",", "Enso", ",", "Eos 2", ",", "Eternal", ",", "Europa by Reason", ",", "FilterShaper3", ",", "Flow II", ",", "Fog Convolver", ",", "Fraction", ",", "FreeAMP", ",", "GrainSpace", ",", "HalfTime", ",", "Harmonic Maximizer", ",", "Heavy Pedal", ",", "Hexonator", ",", "Hologram", ",", "HRTFPanner", ",", "Inertia", ",", "iZotope DDLY Dynamic Delay", ",", "iZotope Mobius Filter", ",", "iZotope Trash 2", ",", "Kontakt", ",", "LDC2 Compander", ",", "Low Filter", ",", "Luminance", ",", "Malfunction II", ",", "MidiShaper", ",", "Modley", ",", "Molecule", ",", "Multitude", ",", "Nectar 3 Elements", ",", "Neutron 3 Elements", ",", "Outer Space", ",", "Ozone 8 Elements", ",", "Panstation", ",", "Polaris", ",", "Pre X7", ",", "Quanta", ",", "QuatroMod", ",", "Reaktor 6 MFX", ",", "Reaktor 6 MIDIFX", ",", "Reaktor 6", ",", "Replicant 2", ",", "Reshuffle", ",", "Robotizer", ",", "RX 7 De-click", ",", "RX 7 De-clip", ",", "RX 7 De-hum", ",", "RX 7 Voice De-noise", ",", "Sequential", ",", "ShaperBox", ",", "Shift", ",", "Side Filter", ",", "Singularity", ",", "Stream", ",", "Svep", ",", "Switch", ",", "SyndtSphere", ",", "The Abuser", ",", "Torsion", ",", "TS-1 Transient Shaper", ",", "Tube Modulator", ",", "Turbo", ",", "ValhallaDelay", ",", "ValhallaRoom", ",", "ValhallaShimmer", ",", "ValhallaSpaceModulator", ",", "ValhallaUberMod", ",", "ValhallaVintageVerb", ",", "VCV Bridge", ",", "Whirl", ",", "XenoVerb" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 418.0, 192.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 17.0, 135.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 318.0, 17.0, 39.0, 22.0 ],
					"text" : "listau"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 17.0, 44.0, 22.0 ],
					"text" : "scan 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 194.0, 128.0, 67.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 236.0, 127.0, 67.0, 20.0 ],
					"text" : "randomize",
					"texton" : "randomize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.547182843261794, 60.0, 55.0, 23.0 ],
					"text" : "midiinfo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.547182843261794, 87.0, 150.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 127.0, 150.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.547182843261794, 32.0, 77.0, 23.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.547182843261794, 157.0, 92.5, 22.0 ],
					"text" : "midiparse"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 10.547182843261794, 117.0, 40.0, 22.0 ],
					"text" : "midiin"
				}
