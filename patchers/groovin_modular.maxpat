...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 686.0, 925.0, 129.0, 130.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 604.5, 652.0, 145.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 146.0, 934.0, 161.0, 104.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 445.0, 596.875, 159.0, 104.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 863.0, 390.0, 345.0, 22.0 ],
					"text" : "sprintf script sendbox channel4 replace groovin_%s_bp.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 863.0, 293.0, 345.0, 22.0 ],
					"text" : "sprintf script sendbox channel3 replace groovin_%s_bp.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 863.0, 204.0, 345.0, 22.0 ],
					"text" : "sprintf script sendbox channel2 replace groovin_%s_bp.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 863.0, 124.0, 345.0, 22.0 ],
					"text" : "sprintf script sendbox channel1 replace groovin_%s_bp.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 928.0, 440.0, 35.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 360.833333333333371, 12.0, 27.0, 20.0 ],
					"text" : "=>"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 274.0, 12.0, 73.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 12.0, 73.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 106.0, 12.0, 73.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					"id" : "obj-13",
					"items" : [ "sampler", ",", "granular", ",", "fsampler" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 12.0, 73.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 31.0, 934.0, 23.0, 90.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 411.0, 621.375, 32.0, 80.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 549.0, 925.0, 130.0, 130.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 604.5, 596.875, 145.5, 51.6875 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 714.0, 735.0, 29.5, 29.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.0, 869.0, 291.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 462.666666666666742, 711.375, 287.333333333333258, 57.625 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 31.0, 715.5, 341.0, 115.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 593.375, 389.0, 111.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 534.0, 703.5, 145.0, 51.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 703.0, 786.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 413.0, 874.0, 64.0, 35.0 ],
					"text" : ";\rdsp open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 839.5, 67.0, 22.0 ],
					"saved_object_attributes" : 					{
						"allwindowsactive" : 0,
						"appicon_mac" : "Macintosh HD:/Users/sa/Music/Max Modules/Groovin/groovin.icns",
						"appicon_win" : "",
						"audiosupport" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 40.5, 915.75, 155.5, 915.75 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 155.5, 1048.0, 520.5, 1048.0, 520.5, 914.0, 695.5, 914.0 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 155.5, 1048.0, 522.5, 1048.0, 522.5, 913.0, 558.5, 913.0 ],
					"order" : 1,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 155.5, 1048.0, 522.5, 1048.0, 522.5, 692.5, 543.5, 692.5 ],
					"order" : 2,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 775.0, 778.75, 762.0, 778.75 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 723.0, 737.25, 811.5, 737.25 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 695.5, 784.25, 712.5, 784.25 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 811.5, 848.0, 775.0, 848.0 ],
					"source" : [ "obj-57", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 712.5, 849.0, 749.0, 849.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-57", 1 ],
					"midpoints" : [ 716.5, 778.75, 762.0, 778.75 ],
					"source" : [ "obj-7", 0 ]
				}
